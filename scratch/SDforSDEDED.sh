...
result_filename=SDforSDEDED_50sta.csv
position_filename=SDforSDEDED_position_50sta.csv
...
result_filename=SDforSDEDED_onlydown.csv
position_filename=SDforSDEDED_position_onlydown.csv
