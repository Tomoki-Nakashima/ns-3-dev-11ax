...
result_filename=EDEDED_50sta.csv
position_filename=EDEDED_position_50sta.csv
...
result_filename=EDEDED_onlydown.csv
position_filename=EDEDED_position_onlydown.csv
